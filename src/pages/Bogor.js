...
export default class Bogor extends Component{
    constructor(props){
        super(props);
        this.state={
            checkeds:false
    ...
    render(){
        return(
            <View style={{backgroundColor:'#A746A3', height:'100%'}}>
                ...
                <Body>
                    <Text style={{fontFamily:'RedHatDisplay-Regular', color:'white', fontWeight:'100', fontSize:normalize(24)}}>Area Bogor</Text>
                </Body>
                </Header>
